...
def train(args):
    ...
    # 1. get data, vocabulary, summary writer (no alteration from baseline)
    ...
    ## Hyperparams (can experiment with values or a different optimizer)
    ...
    # 4. train model (does anything here need to change?)
